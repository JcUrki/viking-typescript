...
describe("Viking", function () {
  ...
  describe("constructor function", function () {
    ...
    test("should receive the name property as its 1st argument", function () {
      expect(viking.name).toEqual(name);
    });

    test("should receive the health property as its 2nd argument", function () {
  ...
  describe("attack() method", function () {
    ...
    test("should return the strength property of the Viking", function () {
  ...
  describe("receiveDamage() method", function () {
    ...
    test("should return \"NAME has received DAMAGE points of damage\", if the Viking is still alive", function () {
